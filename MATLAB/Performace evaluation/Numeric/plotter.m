...
for i = 1:modelCount
    ...
    scatetterPlots(i) = scatter(settlingTime,sae,200,overshoot,'filled', figures(i));
end
redGreen = [interp1([0;1],[0 1 0; 1 1 0;],linspace(0,1,256)); interp1([0;1],[1 1 0; 1 0 0;],linspace(0,1,256))];%
mC = interp1([0;1],[0 0 1; 1 1 0;],linspace(0,1,256));
colormap(redGreen);
cb = colorbar;
ylabel(cb ,"Overshoot")
...
leg1 = legend(ax, [f1 f2 f3], ["Poor control" "Regular control" "Optimize control"], 'Location','east');
pos = get(leg1,'Position');
posx = 0.61;
posy = 0.6;
set(leg1,'Position',[posx posy pos(3) pos(4)]);
